...
<table
	...
	<ul class="wishlist-items-wrapper favorites_content_list">
	<?php
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<li id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>" class="basket_content_item">
				<div class="basket_content_item_row">
					<?php if ( $show_cb ) : ?>
					...
					<div class="product-thumbnail basket_content_slider">
					...
					<div class="basket_content_slider_content">
					<div class="basket_content_slider_text">
					<div class="product-name basket_content_slider_title">
					...
					<div class="basket_price_close">
						...
						<div class="product-remove">
							<div>
								<a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove remove_from_wishlist close_btn" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>">&times;</a>
							</div>
						</div>
					<?php endif; ?>
